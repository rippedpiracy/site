        ...
        {tabs.map((tab, index) => (
          <button
            ...
            className={classNames(
              "font-whitney focus-visible:ring-brand-blurple/75 focus-visible:ring-2 focus-visible:ring-inset rounded-t-md -mb-px border-b-2 px-4 py-2 font-bold whitespace-nowrap transition-colors duration-200 focus:outline-hidden",
              activeTab === index
